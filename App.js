...
const App =() => {
  return(
      <View style={{backgroundColor:'#f8f8f8',alignItems:"center",justifyContent:"center",height:'100%',}}>
        ...
        <Text style={{color:'#000',fontSize:25,fontWeight:'700'}}>GITHUB ACTIONS TEST</Text>D
